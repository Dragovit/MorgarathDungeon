...
/**
 * Trieda GameOverScreen slúži na zobrazenie prehry kde sa nachádzajú tlačidla Play(pre spustenie hry) a Exit(pre ukončenie hry).
...
public class GameOverScreen implements Screen {
     ...
     */
    public GameOverScreen(Hra game) {
        this.game = game;
        this.nadpis = new Texture("obrazovka/game_over.png");
        ...
        this.texturaPostavy = new Texture("postavy/morgarath/doprava/1.png");
    }
